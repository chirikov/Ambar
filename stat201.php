...
if (mysql_num_rows(mysql_query("select * from prodaja")) < 1) {
print "<h3>Нет информации о приходе товаров. Видимо, Вы не получали ещё ни одного товара.</h3>
<br><br>
...
if (isset($go)) {
	...
	window.location = 'stat202.php?grupid=$grupid';
	</script>";
}
mysql_close($mysql);
?>
