...
?>
<h1>Просмотр продажи товара <?php print "$name (артикул $article)" ?> из группы <?php print "$gruppa" ?></h1>
<br>
<?php
$r1 = mysql_query("select * from prodaja");
$n = mysql_num_rows($r1);
$all = 0;
$d7 = 0;
$m1 = 0;
...
<br><b>Всего было продано : <?php print $all ?></b><br><br>
<b>Также можно узнать :</b><br>
<ul type="square">
<li><form action="stat103.php" name="f1">
<input type="Hidden" name="grupid" value="<?php print "$grupid" ?>">
<input type="Hidden" name="tid" value="<?php print "$tid" ?>">
Количество продаж за последние <select name="num1" class=name onfocus='id=className' onblur='id=1'>
<?php
for ($x=1;$x<=31;$x++) {
...
print " продано данного товара : <span id='res11'></span>."; ?></b><br><br></center>
<li><form action="stat103.php" name="f2">
<input type="Hidden" name="grupid" value="<?php print "$grupid" ?>">
<input type="Hidden" name="tid" value="<?php print "$tid" ?>">
...
<option value="11">ноября
<option value="12">декабря
</select> <select name="year2" class=name onfocus='id=className' onblur='id=1' size="1">
<?php
for($i=2003;$i < 2008; $i++) {
...
<br><br>
<form action='stat203.php'>
<input type="Hidden" name="grupid" value="<?php print $grupid ?>">
<input type="Hidden" name="tid" value="<?php print $tid ?>">
<input type=Submit value='Просмотреть приход этого товара' class='submit' onmouseover='id=className' onmouseout=id='0'>
</form>
<br><br>
<form action='stat102.php'>
<input type="Hidden" name="grupid" value="<?php print $grupid ?>">
