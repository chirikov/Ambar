...
print "<h3>Нет информации о продаже товаров. Видимо, Вы не продали ещё ни одного товара.</h3>
<br><br>
...
print "<table class='table' cellspacing='0'>";
	...
	reset($p);
	for($x=0;$x<count($p);$x++) {
		print "<form action='stat101.php'><input type='hidden' name='x2' value='$x'>";
...
if (isset($go)) {
	...
	window.location = 'stat102.php?grupid=$grupid';
	</script>";
}
mysql_close($mysql);
?>
