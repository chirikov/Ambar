...
?>
<h1>Распределение товаров по поставщикам</h1><br><br>
<img src="diagr.php?naminpos=1" name="ambarimage">
<br><br>
<h3>Всего поставщиков : <?php print mysql_num_rows(mysql_query("select id from postavsh")) ?>&nbsp;&nbsp; Всего товаров : <?php print $num0 ?></h3>
<br><br>
<form action="graph.php">
<input type="Submit" value="Вернуться назад" class='submit' onmouseover='id=className' onmouseout=id='0' accesskey=','>
</form>
